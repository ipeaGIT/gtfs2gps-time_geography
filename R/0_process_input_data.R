...
fixed_link <- "https://github.com/ipeaGIT/gtfs2gps-time_geography/releases/download/data"
emtu_link <- sprintf("%s/gtfs_spo_emtu_2019-06.zip", fixed_link)
sptrans_link <- sprintf("%s/gtfs_spo_sptrans_2019-06.zip", fixed_link)
dir.create("data-raw/")
